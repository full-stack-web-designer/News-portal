...
<html>
<head>
	<title>News Portal | Unapprove Comments</title>
                    ...
                    <tbody>
                      <?php 
                        ...
                        <tr>
                            ...
                            <td><a href="unapprove_comments.php?appid=<?php echo htmlentities($row['id']);?>"><i style="color: #29b6f6;">Approve</i></a> 
                          		&nbsp;<a href="unapprove_comments.php?rid=<?php echo htmlentities($row['id']);?>&&action=del"><i style="color: #f05050">Delete</i></a> </td>
                        </tr>
                        <?php
                        $cnt++;
                        } ?>
